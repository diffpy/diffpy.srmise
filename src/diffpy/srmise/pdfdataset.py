...
class PDFDataSet(PDFComponent):
    ...
    def clear(self):
        ...
        The purpose of this method is to set the PDF dataset to initial
        empty values.
        """
        self.robs = []
        self.Gobs = []
    ...
    def setvar(self, var, value):
        """Assign a data member using PdfFit-style variable notation. This
        method is typically utilized by the `applyParameters()` function.
