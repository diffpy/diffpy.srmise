...
class SrMiseDataFormatError(SrMiseError):
    """diffpy.srmise exception class.

    Error in formatted data.
    """
...
class SrMiseEstimationError(SrMiseError):
    """diffpy.srmise.modelevaluator exception class.
...
class SrMiseLogError(SrMiseError):
    ...
    Error while handling logging capabilities.
    """
...
class SrMiseScalingError(SrMiseError):
    """diffpy.srmise.peaks exception class.

    Error when scaling a peak function.
    """
...
class SrMiseStaticOwnerError(SrMiseError):
    ...
    Attempt to change owner of static model part.
    """
...
class SrMiseTransformationError(SrMiseError):
    ...
    Error transforming model/covariance parameters.
    """
...
class SrMiseUndefinedCovarianceError(SrMiseError):
    ...
    Attempted to perform on undefined covariance.
    """
...
class SrMisePDFKeyError(SrMiseError):
    ...
    Requested PDF key can't be found.
    """
