...
class GaussianOverR(PeakFunction):
    ...
    def __init__(self, maxwidth, Cache=None):
        """Maxwidth defined as full width at half maximum for the corresponding
        Gaussian, which is physically relevant."""
    ...
    def _transform_derivativesraw(self, pars, in_format, out_format):
        """Return gradient matrix for the pars converted from in_format to
        out_format.
    ...
    def _valueraw(self, pars, r):
        """Compute the value of a width-limited Gaussian/r for the specified
        parameters at given radial distances.
